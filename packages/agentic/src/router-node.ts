...
const KEYWORD_ROUTES: KeywordRoute[] = [
  ...
  {
    keywords: ['nếu tôi', 'giả sử', 'what if', 'nếu vay thêm', 'giả lập', 'mô phỏng', 'tình huống'],
    intent: AgentIntent.SIMULATION,
  },
  {
    keywords: ['giá vàng', 'bitcoin', 'crypto', 'cổ phiếu', 'nên đầu tư', 'phân bổ', 'danh mục', 'mua vàng'],
    intent: AgentIntent.INVESTMENT_ADVICE,
  },
  {
    keywords: ['thị trường hôm nay', 'tổng quan thị trường', 'fear and greed', 'chỉ số thị trường'],
    intent: AgentIntent.MARKET_OVERVIEW,
  },
  {
    keywords: ['giá vàng hôm nay', 'btc hôm nay', 'chỉ số vn-index', 'giá eth'],
