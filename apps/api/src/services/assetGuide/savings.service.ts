...
const TENOR_LABEL: Record<string, string> = {
  t1: '1 tháng', t3: '3 tháng', t6: '6 tháng',
  t9: '9 tháng', t12: '12 tháng', t18: '18 tháng', t24: '24 tháng',
};
...
function buildSavingsItems(riskLevel: string): SavingsItem[] {
  ...
  return sorted.slice(0, 6).map((bank, i) => {
    ...
    const otherTenors = preferTenors.slice(1).map(t => `${TENOR_LABEL[t]}: ${bank.online[t]}%`).join(' · ');
