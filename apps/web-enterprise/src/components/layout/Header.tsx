...
import { Bell, ChevronDown, LayoutDashboard, LogOut, Menu, PanelLeftClose, User, X } from 'lucide-react';
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        >
          ...
          />
          <span style={{ color: 'var(--color-text-muted)', fontWeight: 600 }}>FinSight Enterprise</span>
                    ...
                    notifs.map((n) => (
                      <div
                        ...
                        style={{
                          ...
                          cursor: 'pointer',
                          borderBottom: '1px solid var(--color-border)',
                          background: !n.isRead ? 'rgba(16,185,129,0.04)' : 'transparent',
          ...
          <AnimatePresence>
            {avatarOpen && (
              <Panel width="w-52">
                ...
                <div style={{ padding: 6 }}>
                  {[
                    { to: '/profile', icon: User, label: 'Hồ sơ', color: '#10b981' },
                    { to: '/home', icon: LayoutDashboard, label: 'Dashboard', color: '#3b82f6' },
                  ].map((item) => (
                    <Link
                      key={item.to}
                      to={item.to}
