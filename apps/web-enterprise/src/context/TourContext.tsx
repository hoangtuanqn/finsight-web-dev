...
const STEPS = [
  ...
  },
  {
    ...
    popover: {
      title: '📉 Chỉ số DTI',
      description: 'Debt-to-Income Ratio đo tỉ lệ thu nhập bị chiếm bởi nợ. DTI < 20% là an toàn, > 50% là nguy hiểm.',
      side: 'right',
      align: 'start',
    },
  },
  ...
  },
  {
    ...
    popover: {
      title: '👤 Hồ sơ cá nhân',
      description: 'Cập nhật thu nhập, vốn đầu tư và các thông số tài chính để mở khóa đầy đủ tính năng tư vấn AI.',
      side: 'right',
      align: 'start',
    },
  },
  ...
  },
  {
    ...
    popover: {
      ...
      description: 'Theo dõi toàn bộ hóa đơn nâng cấp, trạng thái thanh toán và lịch sử giao dịch của bạn tại đây.',
      side: 'right',
      align: 'start',
    },
  },
