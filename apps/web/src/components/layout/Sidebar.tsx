...
function getRemainingDays(date: string | Date) {
  if (!date) return 0;
            ...
            {!isCollapsed && (
              ...
              >
                <div className="flex items-center gap-1.5">
                  ...
                  {user?.level === 'PROMAX' && (
                    <div
                      className="flex items-center justify-center w-4 h-4 rounded bg-amber-500/20 text-amber-500"
                      title="Pro Max"
                    >
                      <Crown size={10} />
                    </div>
                  ...
                  {user?.level === 'PRO' && (
                    <div
                      className="flex items-center justify-center w-4 h-4 rounded bg-blue-500/20 text-blue-500"
                      title="Pro"
                    >
                      <Zap size={10} />
                    </div>
