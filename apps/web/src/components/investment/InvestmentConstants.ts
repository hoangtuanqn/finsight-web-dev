...
export const INVESTMENT_SUGGESTIONS = {
    ...
    items: [
      {
        ...
        tag: "An toàn nhất",
        rate: "5.5-6.5%/năm",
        note: "Rủi ro gần bằng 0, lãi suất cố định, kỳ hạn 2-10 năm",
        badge: "Khuyên dùng",
        badgeColor: "purple",
      },
      {
        ...
        tag: "Ngân hàng lớn",
        rate: "6.0-7.0%/năm",
        note: "An toàn cao, thanh khoản tốt, phát hành định kỳ",
        badge: "Ổn định",
        badgeColor: "blue",
      },
      {
        ...
        tag: "Quỹ trái phiếu",
        rate: "~6-7%/năm",
        note: "Quản lý chuyên nghiệp, đa dạng nhiều loại TP",
        badge: "Tiện lợi",
        badgeColor: "blue",
      },
    ],
    tips: [
      "Tránh trái phiếu doanh nghiệp bất động sản lãi suất cao bất thường",
      "Kỳ hạn 2-5 năm là cân bằng tốt giữa lãi suất và thanh khoản",
      "Có thể mua qua app MBBank, TCBS với lô nhỏ 1-10 triệu",
    ],
  },
  crypto: {
    label: "Crypto",
  ...
  stocks_us: {
    ...
    items: [
      { name: 'S&P 500 ETF (SPY)', tag: 'ETF', rate: 'Theo S&P 500', note: '500 công ty lớn nhất Mỹ, rủi ro thấp nhất trong nhóm', badge: 'Khuyên dùng', badgeColor: 'amber' },
      { name: 'Nasdaq 100 (QQQ)', tag: 'Công nghệ', rate: 'Theo Tech', note: 'Tập trung Big Tech (Apple, MSFT, NVIDIA), tăng trưởng cao', badge: 'Tăng trưởng', badgeColor: 'emerald' },
      { name: 'Apple (AAPL)', tag: 'Tech', rate: 'Big Tech', note: 'Vốn hóa siêu lớn, ổn định và có cổ tức', badge: 'An toàn', badgeColor: 'blue' },
    ],
    tips: ['Sử dụng ETF giúp đa dạng hóa ngay lập tức', 'Đầu tư Mỹ mang lại lợi thế về tỷ giá USD/VND', 'Nên xác định đầu tư dài hạn (trên 3 năm) để vượt qua biến động tỷ giá'],
  },
};
