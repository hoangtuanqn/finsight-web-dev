...
import { CheckCircle, Lock, Rocket, Shield, TrendingUp, User, Wallet } from 'lucide-react';
              ...
              {saved && (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[12px] font-medium opacity-80">Dữ liệu đã được lưu trữ an toàn trên hệ thống.</p>
                  </div>
                </motion.div>
              )}
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-[12px] text-[var(--color-text-secondary)] font-medium leading-relaxed max-w-[320px]">
                      Dữ liệu của bạn được mã hoá theo chuẩn bảo mật cấp cao nhất và chỉ sử dụng cho{' '}
                      <strong>tư vấn AI cá nhân hóa</strong>.
                    </p>
                  </div>
                ...
                <div className="mt-8 p-6 rounded-2xl bg-[var(--color-bg-secondary)] border border-[var(--color-border)] flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[13px] text-[var(--color-text-secondary)] leading-relaxed">
                      Để đảm bảo an toàn tuyệt đối cho tài sản và dữ liệu, FinSight khuyến nghị bạn luôn bật tính năng
                      Xác thực đa lớp. Mọi thao tác rút tiền và thay đổi thông tin quan trọng đều sẽ yêu cầu mã OTP từ
                      ứng dụng.
                    </p>
                  </div>
                </div>
