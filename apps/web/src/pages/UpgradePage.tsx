...
const PLANS = [
  {
    ...
    features: [
      ...
      { text: 'AI Chatbot hỗ trợ (5 lần/tháng)', included: true, highlight: '5 lần / tháng' },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'AI Chatbot (20 câu / 1 giờ)', included: true, highlight: '20 câu / 1h' },
      { text: 'OCR nhận diện (100 ảnh / tháng)', included: true, highlight: '100 ảnh / tháng' },
...
export default function UpgradePage() {
  ...
  const [levelExpiresAt, setLevelExpiresAt] = useState<string | null>(null);
