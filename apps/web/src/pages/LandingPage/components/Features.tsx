...
export default function Features() {
  ...
  const FeatureRow = ({ title, icon: Icon, iconColor, glowColor, desc, bullets, isReversed, children }: { title: string, icon: any, iconColor: string, glowColor: string, desc: string, bullets: string[], isReversed?: boolean, children: React.ReactNode }) => (
