...
export default function DebtOverviewPage() {
  ...
  const filteredDebts = useMemo(() => {
    ...
    return (debtsData as any[]).filter((debt: any) => {
      // Client-side search
      if (filters.search) {
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) => setTempFilters((f: any) => ({ ...f, search: e.target.value }))}
                ...
                <div className="space-y-3">
                  ...
                  <select
                    ...
                    onChange={(e) => setTempFilters((f: any) => ({ ...f, dueInDays: e.target.value }))}
