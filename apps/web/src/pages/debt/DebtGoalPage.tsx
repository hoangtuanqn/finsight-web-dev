...
function GoalForm({ existing, onSaved, onCancel }: { existing: any, onSaved: () => void, onCancel: (() => void) | null }) {
...
export default function DebtGoalPage() {
  ...
  const { data, isLoading: loading } = useDebtGoal() as { data: any, isLoading: boolean };
