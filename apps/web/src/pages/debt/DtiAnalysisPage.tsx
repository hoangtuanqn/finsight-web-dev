...
const ZONE_MESSAGES = {
  ...
  WARNING:
    "DTI vượt 35% - nợ chiếm tỉ trọng lớn trong thu nhập. Cần kế hoạch giảm nợ cụ thể.",
  CRITICAL:
    "DTI vượt 50% - mức nguy hiểm! Nguy cơ mất khả năng thanh toán rất cao. Cần hành động ngay.",
};
...
export default function DtiAnalysisPage() {
  ...
  const zone =
    ZONE_CONFIG[summary.zone as keyof typeof ZONE_CONFIG] || ZONE_CONFIG.SAFE;
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {[
          ...
          >
            ...
            <p
              className={`text-2xl font-black bg-gradient-to-r ${item.gradient} bg-clip-text text-transparent mb-1`}
            >
              {item.value}
            </p>
      ...
      >
        ...
        />
        <p className="text-[13px] font-black text-[var(--color-text-primary)] mb-5">
          Thang đo DTI
        </p>
      ...
      {summary.zone !== "SAFE" && (
        ...
        >
          ...
          <p className="text-[13px] font-black text-[var(--color-text-primary)] mb-5 flex items-center gap-2">
            <Lightbulb size={15} className="text-amber-400" /> Để đạt DTI an
            toàn (&lt; 20%)
          </p>
          <div className="space-y-4">
              ...
              <div>
                <p className="text-[13px] text-[var(--color-text-primary)]">
                  ...
                  <span className="font-black text-emerald-400">
                    {formatVND(whatIf.incomeNeededForSafe)}/tháng
                  </span>
                </p>
                <p className="text-[11px] text-[var(--color-text-muted)] mt-0.5">
                  ...
                  {formatVND(
                    Math.max(
                      0,
                      whatIf.incomeNeededForSafe - summary.monthlyIncome,
                    ),
                  )}
                  /tháng
                </p>
              ...
              <div>
                <p className="text-[13px] text-[var(--color-text-primary)]">
                  ...
                  <span className="font-black text-blue-400">
                    {formatVND(summary.monthlyIncome * 0.2)}
                  </span>
                </p>
                <p className="text-[11px] text-[var(--color-text-muted)] mt-0.5">
      ...
      {summary.zone === "SAFE" && (
        ...
        >
          ...
          <p className="text-emerald-400 font-black text-lg mb-1">
            DTI đang ở vùng an toàn!
          </p>
          <p className="text-[var(--color-text-muted)] text-sm">
            Tiếp tục theo dõi để duy trì chỉ số này.
          </p>
        </motion.div>
      )}
    </motion.div>
