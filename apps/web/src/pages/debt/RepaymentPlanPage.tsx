...
const STRATEGY_CONTENT = {
  AVALANCHE: {
    ...
    emoji: "⚡",
    description:
      "Phương pháp Avalanche tập trung trả khoản nợ có lãi suất cao nhất trước, trong khi vẫn trả tối thiểu cho các khoản còn lại. Khi khoản lãi cao nhất được trả xong, chuyển toàn bộ ngân sách đó sang khoản có lãi suất cao thứ hai - như một trận tuyết lở tích lũy momentum.",
    howItWorks: [
    ...
    worstFor:
      "Người cần động lực liên tục, dễ bỏ cuộc khi không thấy kết quả sớm.",
  },
  SNOWBALL: {
    name: "Snowball",
    ...
    emoji: "⛄",
    description:
      'Phương pháp Snowball tập trung trả khoản nợ có dư nợ NHỎ NHẤT trước, bất kể lãi suất. Mỗi lần trả xong một khoản, bạn có cảm giác chiến thắng và tăng động lực. Như một quả cầu tuyết lăn xuống dốc - mỗi "win" nhỏ tạo đà cho chiến thắng lớn hơn.',
    howItWorks: [
    ...
    bestFor:
      "Người cần động lực thường xuyên, đã từng thất bại với kế hoạch trả nợ, hoặc đang có nhiều khoản nợ nhỏ cần dọn sạch.",
    worstFor:
      "Người có 1-2 khoản nợ lớn với lãi suất rất cao - Avalanche sẽ tiết kiệm hơn đáng kể.",
  },
};
...
function StrategyModal({
  ...
  type: keyof typeof STRATEGY_CONTENT;
  onClose: () => void;
}) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`absolute top-0 left-8 right-8 h-px bg-gradient-to-r from-transparent ${glowColor} to-transparent`}
        />
        <div
          className={`absolute -top-12 right-0 w-40 h-40 rounded-full blur-3xl opacity-10 ${bgGlow}`}
        />
        ...
        <div className="p-6 pt-4">
          <div className="flex items-start justify-between mb-5">
            <div className="flex items-center gap-3">
              <div
                className={`w-11 h-11 rounded-2xl flex items-center justify-center bg-${color}-500/15 text-${color}-400`}
              >
                <Icon size={22} />
              </div>
              <div>
                <h2 className={`text-[20px] font-black text-${color}-400`}>
                  {emoji} {name}
                </h2>
          ...
          <div
            className={`rounded-2xl p-4 mb-4 bg-${color}-500/6 border border-${color}-500/15`}
          >
            ...
            <ol className="space-y-2">
              {howItWorks.map((step, i) => (
                <li key={i} className="flex items-start gap-2.5">
                  <span
                    className={`shrink-0 w-5 h-5 rounded-full bg-${color}-500/20 text-${color}-400 text-[10px] font-black flex items-center justify-center mt-0.5`}
                  >
                    {i + 1}
                  </span>
...
export default function RepaymentPlanPage() {
  ...
  const [modal, setModal] = useState<keyof typeof STRATEGY_CONTENT | null>(
    null,
  );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <div className="flex items-center gap-2.5 mb-2">
                  ...
                  <h3 className="font-black text-blue-400 text-[16px]">
                    Avalanche
                  </h3>
                  <span className="px-2 py-0.5 rounded-full bg-blue-500/15 text-blue-300 text-[10px] font-black">
                    Tiết kiệm lãi
                  </span>
                  <button
              ...
              >
                ...
                <div className="flex items-center gap-2.5 mb-2">
                  ...
                  <h3 className="font-black text-emerald-400 text-[16px]">
                    Snowball
                  </h3>
