  ...
  if (!data)
    return (
      <div className="flex flex-col items-center justify-center py-24 gap-4">
        ...
        <Link
          to="/debts"
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-blue-600 text-white font-bold text-sm hover:bg-blue-500 transition-all cursor-pointer"
        >
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="pb-8 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {[
              ...
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: `0 4px 16px ${item.color}06`,
                }}
              >
                <div
                ...
                />
                <p className="text-[10px] font-black text-[var(--color-text-muted)] uppercase tracking-widest mb-2">
                  {item.label}
                </p>
                <p className={`text-base font-black bg-gradient-to-r ${item.gradient} bg-clip-text text-transparent`}>
                  {item.value}
                </p>
              </motion.div>
            ))}
        ...
        <div>
          <div
            className="rounded-3xl border p-5 sticky top-24 relative overflow-hidden"
            style={{ background: 'var(--color-bg-card)', borderColor: 'rgba(16,185,129,0.15)' }}
          >
            ...
            <div className="space-y-2.5">
              {[
                ...
                <div key={r.label} className="flex justify-between text-[12px]">
                  ...
                  <span className="font-bold" style={{ color: r.vColor }}>
                    {r.value}
                  </span>
                </div>
              ))}
