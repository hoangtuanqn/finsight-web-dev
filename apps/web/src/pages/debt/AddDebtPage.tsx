            ...
            >
              ...
              <div className="p-6">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-sm font-bold text-slate-900 dark:text-slate-200">
                        Thiết lập Phạt trễ hạn (Kép)
                      </h3>
                      <p className="text-[11px] text-slate-500">
                        Tự động tính thêm dư nợ và trừ Điểm Sức Khoẻ khi trễ hẹn
                      </p>
                    </div>
                  </div>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.checked) {
                            ...
                            setValue('feePenaltyPerDay', 0, { shouldValidate: true, shouldDirty: true });
                          }
                        }}
                  ...
                  <div className={formValues.feePenaltyPerDay > 0 ? 'block' : 'hidden'}>
                    <div className="mt-4 p-4 rounded-2xl bg-rose-500/5 border border-rose-500/10">
                      <label className="input-label text-rose-600 dark:text-rose-300">
                        {debtType === 'INSTALLMENT'
                          ? 'Phí phạt cố định mỗi ngày (VND)'
                          : 'Phí phạt trễ hạn 1 lần (VND)'}
                      </label>
                      <Controller
                ...
                {ear > formValues.apr && (
                  <div className="flex items-start gap-2 px-3 py-2.5 rounded-2xl border border-red-500/20 bg-red-500/6 mt-4">
                    ...
                    <p className="text-[12px] text-red-400 font-medium">
                      Chi phí ẩn: <span className="font-black">+{formatPercent(ear - formValues.apr)}</span> so với
                      quảng cáo
                    </p>
                  </div>
                )}
                  ...
                  {debtType === 'INSTALLMENT' ? (
                    ...
                    <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-3">
                      ...
                      <p className="text-[12px] font-medium text-yellow-700 dark:text-yellow-400">
                        Lãi suất kép được tính dựa trên dư nợ hiện tại. Chỉ trả mức tối thiểu sẽ kéo dài thời gian trả
                        nợ rất lâu.
                      </p>
                    </div>
                  )}
