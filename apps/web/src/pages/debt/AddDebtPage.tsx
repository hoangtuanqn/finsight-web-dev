...
export default function AddDebtPage() {
  ...
  const remaining = calcRemainingTerms(
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  ...
                  <div>
                    ...
                    {errors.name && (
                      <p className="mt-1 text-[12px] text-red-400 flex items-center gap-1">
                        <AlertTriangle size={11} /> {errors.name.message}
                      </p>
                    )}
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    {errors.balance && (
                      <p className="mt-1 text-[12px] text-red-400 flex items-center gap-1">
                        <AlertTriangle size={11} /> {errors.balance.message}
                      </p>
                    )}
                  </div>
                  <div>
                    ...
                    {errors.apr && (
                      <p className="mt-1 text-[12px] text-red-400 flex items-center gap-1">
                        <AlertTriangle size={11} /> {errors.apr.message}
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    {errors.minPayment && (
                      <p className="mt-1 text-[12px] text-red-400 flex items-center gap-1">
                        <AlertTriangle size={11} /> {errors.minPayment.message}
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    {errors.startDate && (
                      <p className="mt-1 text-[12px] text-red-400 flex items-center gap-1">
                        <AlertTriangle size={11} /> {errors.startDate.message}
                      </p>
                    )}
                  </div>
                  <div>
                    ...
                    {errors.termMonths && (
                      <p className="mt-1 text-[12px] text-red-400 flex items-center gap-1">
                        <AlertTriangle size={11} /> {errors.termMonths.message}
                      </p>
                    )}
                  </div>
                  <div>
                    <label className="input-label">
                      Ngày đáo hạn hàng tháng
                    </label>
                    <input
                      type="number"
                    ...
                    {errors.dueDay && (
                      <p className="mt-1 text-[12px] text-red-400 flex items-center gap-1">
                        <AlertTriangle size={11} /> {errors.dueDay.message}
                      </p>
                    )}
                  </div>
                </div>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-[13px] font-black text-purple-400">
                  {formatPercent(apy)}
                </span>
              </div>
              <div
                ...
                <div className="flex items-start gap-2 px-3 py-2.5 rounded-2xl border border-red-500/20 bg-red-500/6">
                  ...
                  <p className="text-[12px] text-red-400 font-medium">
                    ...
                    <span className="font-black">
                      +{formatPercent(ear - formValues.apr)}
                    </span>{" "}
                    so với quảng cáo
                  </p>
                </div>
