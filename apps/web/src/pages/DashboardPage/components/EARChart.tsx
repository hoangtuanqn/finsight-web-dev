...
export default function EARChart({
  earChartData = [],
}: {
  earChartData?: any[];
}) {
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "0 4px 30px rgba(59,130,246,0.08), 0 1px 0 rgba(59,130,246,0.2) inset",
      }}
    >
      {/* Top accent */}
      ...
      <div className="flex items-center gap-6 pt-4 mt-2 border-t border-white/5">
        <div className="flex items-center gap-2 text-[11px] text-[var(--color-text-secondary)]">
          <div className="w-3 h-3 rounded-sm bg-gradient-to-b from-blue-400 to-blue-600" />{" "}
          APR (quảng cáo)
        </div>
        <div className="flex items-center gap-2 text-[11px] text-[var(--color-text-secondary)]">
