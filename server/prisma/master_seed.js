...
async function main() {
  ...
  await prisma.article.createMany({
    data: [
      ...
      {
        title: 'Hiểu Về Điểm Tín Dụng CIC Tại Việt Nam',
        author: 'FinSight Expert',
        date: '2026-04-10',
        imageUrl: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=800',
        excerpt: 'Làm thế nào để duy trì điểm tín dụng tốt và tránh nợ xấu CIC?',
        content: 'Điểm tín dụng là chỉ số quan trọng...',
        category: 'GUIDE',
      },
      {
        title: 'Quy Tắc 50/30/20 Trong Quản Lý Chi Tiêu',
        author: 'Admin',
        date: '2026-04-05',
        imageUrl: 'https://images.unsplash.com/photo-1567427017947-545c5f8d16ad?w=800',
        excerpt: 'Phân bổ thu nhập hợp lý để vừa trả được nợ vừa có tích luỹ.',
        content: 'Chia thu nhập thành 3 phần chính...',
        category: 'GUIDE',
      },
      {
        title: 'Snowball vs Avalanche: Chọn Phương Pháp Nào?',
        author: 'FinSight Team',
        date: '2026-04-18',
        imageUrl: 'https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=800',
        excerpt: 'So sánh chi tiết hai phương pháp trả nợ phổ biến nhất hiện nay.',
        content: 'Snowball tập trung vào tâm lý, Avalanche tập trung vào toán học...',
        category: 'GUIDE',
      },
      {
        title: 'Tâm Lý Học Tiêu Dùng: Tại Sao Chúng Ta Mua Sắm Quá Đà?',
        author: 'Dr. Tài Chính',
        date: '2026-03-25',
        imageUrl: 'https://images.unsplash.com/photo-1556742044-3c52d6e88c62?w=800',
        excerpt: 'Giải mã những cái bẫy tâm lý khiến bạn chi tiêu vượt mức kiểm soát.',
        content: 'Dopamine và cảm giác mua sắm...',
        category: 'STORY',
      },
      {
        title: 'Đầu Tư Gì Với 5 Triệu Đồng Mỗi Tháng?',
        author: 'Advisor X',
        date: '2026-04-01',
        imageUrl: 'https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?w=800',
        excerpt: 'Các kênh đầu tư an toàn và hiệu quả cho người mới bắt đầu với số vốn nhỏ.',
        content: 'Chứng chỉ quỹ, tiết kiệm, hay vàng?',
        category: 'NEWS',
      },
      {
        title: 'Bẫy Nợ Thẻ Tín Dụng: Cách Phòng Tránh Hiệu Quả',
        author: 'Ngân Hàng Insider',
        date: '2026-03-15',
        imageUrl: 'https://images.unsplash.com/photo-1544377193-33dcf4d68fb5?w=800',
        excerpt: 'Những điều nhân viên ngân hàng không nói với bạn về lãi suất thẻ tín dụng.',
        content: 'Lãi chồng lãi và cách tính lãi suất thực tế...',
        category: 'GUIDE',
      },
    ],
  });
