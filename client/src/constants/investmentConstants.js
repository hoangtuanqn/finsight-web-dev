...
export const ASSET_CLASSES = {
  savings: {
    label: 'Tiết kiệm',
    expectedReturn: 0.050,  // 5.0%/năm — lãi suất tiết kiệm 12T TB NH lớn VN 2024 (nguồn: NHNN)
  ...
  stocks: {
    label: 'Cổ phiếu',
    expectedReturn: 0.10,   // 10.0%/năm — VN-Index CAGR 2014-2024, bao gồm giai đoạn COVID
    stdDev: 0.22,           // biến động đáng kể, phù hợp dài hạn
  },
  crypto: {
    label: 'Tiền mã hóa',
    expectedReturn: null,   // Không dùng point estimate — biến động quá lớn, misleading
    bearCase:  -0.60,       // -60% (đã xảy ra: BTC 2022)
    baseCase:   0.20,       // +20% (kịch bản trung bình)
    bullCase:   1.50,       // +150% (đã xảy ra nhiều lần)
    stdDev: 0.80,
