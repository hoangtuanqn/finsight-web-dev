    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-6 relative overflow-hidden">
      ...
      >
        ...
        <h2 className="text-3xl font-bold text-white tracking-tight mb-4">
          Dữ liệu đang được khóa
        </h2>
        
        <p className="text-base font-medium text-slate-400 mb-10 leading-relaxed">
          Hệ thống AI cần thông tin <span className="text-white font-semibold">Thu nhập</span> và <span className="text-white font-semibold">Số vốn</span> của bạn để khởi chạy mô hình phân bổ tài sản thông minh.
        </p>
